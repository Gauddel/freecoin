...
class GiveTokens extends React.Component {
    ...
    approve(tokensOwner, spender, tokens) {
        Free.approve(tokensOwner, spender, tokens);
    }
        ...
        return (
            ...
            <div className="col-8">
                <div>
                    ...
                    <button className="btn btn-primary" type="submit" onClick={() => this.approve(this.state.tokensOwner,
                        this.state.spender,
                        this.state.tokens)}>Give</button>
                </div>
            </div>
            <div className="col-2"></div>
            </div>
